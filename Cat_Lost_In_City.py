...
[ |_____| | .   . | |____________________________| | .   . | |__]
    ...
    """)
    if len(inventory) > 0:
        typewrite(f"\nOn your travels, you found a total of {len(inventory)} out of a possible 4 items.")
        print("\n",inventory,"\n\n\n")
    else:
        typewrite(f"\nOn your travels, you found a total of 0 out of a possible 4 items.")
...
By paw, there's two ways you could go.. If you head out of here and go straight on you'll come to an alleyway, follow that around and you'll arrive at the station. It's quite a long way though and there's some dodgy characters around. Alternatively you could take a shortcut through the river just over there. You'll have to get wet and try to swim, it's a little risky, but you'll reach home much sooner if you manage it.'\n\n""")
...
def A5():
    ...
    order_solved=False
    typewrite(f"You must help {your_name} swim accross the river in a particular way - otherwise, the rapids will surely sweep the cat back to shore! ")
...
~~~,_,.---.~~~~~..,,,_,__.~~~~~,_-(o.o)-_~,_,.---.~~~~~..,,,_,__.~~~~~,_,.----
          ...
          ^  -                    "   "          -                              -   
            ...
            clearConsole()
            print(f"{your_name} decides to {order_options[answer]} but as soon as {your_name} tries to enter the water, the current pulls the cat right back. Try something else.")
...
#Add cherries too inventory
  ...
  """)
    ...
    typewrite(colored(0, 255, 0, "\n 1- Try and get past the Robot Security Guard OR \n2- We can escape through my tunnel system."))

    escape_route = input (colored(0, 255, 0," \n\n Type which option you choose 1, 2 or go back to the start:"))
...
Good luck!")
    ...
    while count <= 9:
        ...
        if op == add:
            ...
            if question_mul == answer_mul:
                ...
                count = count + 1
        if count == 10:
            print(colored(0, 255, 0,"You have completed the quiz. Your final score out of 10 is "+str(score_2)+"."))
    ...
    if score_2 >= 8:
        ...
        print ("Well you are no maths genious. I'm afraid you can't pass through the gate today.\n") #Link too B
        AB ()
def AB ():
...
"3: Do nothing"   
    ...
    print(colored (0, 255, 0, Robot_guard))

    Pass_Guard = input (colored(0, 255, 0,"Which do you choose? Input 1, 2 or 3:"))
...
You must score 100 on my quiz to pass.")
    ...
    total_questions=3
    #Maths Quiz
    answer=input(colored(0, 255, 0, "Are you ready to play the Quiz ? (yes/no) :"))
    score=0
    total_questions= 4
    ...
    if mark == 100:
        ...
        print (f"You did not score high enough. You will be taken to the pet shelter in the morning.\n\n {your_name} runs away, ending up back at the start")
        input("\npress enter")
        answer = False
        animals.pop(1)
        animals.insert(1,"")
...
Hey do you remember the cherries I gave you earlier? \n\
...
You should eat it to get some energy!")
   ...
   """)
    ...
    input(colored(100, 100, 255,"[EAT CHERRIES]"))
    inventory.remove("cherries")
...
---~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    typewrite (colored(0, 255, 0,"You can either 1- Take the Night bus \n\
OR 2- get help from another animal\n\
Which will it be?"))

    end_of_fox = input (colored(0, 255, 0,"Type which option you choose 1, 2 or go back to the start:"))
...
'Bus driver: It's the Last train of the night cat.'
  ...
  """)
    ...
    yes_no_3 = input (colored(0, 255, 0,"Busdriver: You getting on or what? type yes/no:") )
...
#C / RAT PATH
def C1():
    typewrite("\nHi, I am Ratty, the landfill upcyling genius!\n")  
    print ("""
  .--,       .--,
 ( (  \.---./  ) )
  '.__/o   o\__.'
 ...
 """) 
    ...
    =  = ==(____AA____D
                ...
                `~-.__        ___..----..                  )
                      ...
                      =  ===(_________D
 \n""")
    typewrite(colored(0, 255, 0,"Ratty asks which vehicle you'd like:\n"))
    answer = input(colored(0, 255, 0,"Car(1)    Plane(2) "))
    if answer == '1':
        typewrite("\nCar\n")
        C2()
    elif answer == '2':
...
def C2():
    ...
    typewrite(colored(0, 255, 0,"\nScenic route(1)    Through the city(2)? "))
    answer = input("\n: ")
    if answer == '1':
        typewrite("\nScenic route\n")
        C4()
        ...
        C5()
def C3():
    typewrite(colored(0, 255, 0,"\nThere is a Tornado right ahead. Do you: \n"))
    answer = input(colored(0, 255, 0,"\nStay(1) or Jump(2)? : "))
    if answer == '1':
        typewrite("\nStay\n")
        C6()
...
\n""")
    ...
    if answer == '1':
        ...
        C9()
def C5():
    typewrite(colored(0, 255, 0,"\nA few minutes into the journey. Disaster happens. You can either:\n\n"))
    answer = input(colored(0, 255, 0,"\nBreak down(1) Crash into lampost(2)? :"))
    if answer == '1':
        typewrite("\nBreak down\n")
        C10()
    elif answer == '2':
        ...
        C11()
def C6():
    typewrite("\nAs the plane flies into the tornado. There is a massive thud. Cat is now in a magical land, and is approached by a: \n")
    print ("""
                 .##@@&&&@@##.
              ,##@&::%&&..::&@##.
             #@&:..000000000..:&@#
...
def C7():
    typewrite("\nVery brave. What now?\n\n")
    answer = input(colored(0, 255, 0,"\nFall onto a stray helium balloon(1) Saved by ratty with a back-pack super rocket?(2)? : "))
    if answer == '1':
        typewrite("\nBalloon\n")
        C14()
    elif answer == '2':
        ...
        C15()
def C8():
    typewrite("\nThe alien is waving at you on the roadside. He needs your help\n")
    input ("""
      .--.   |V|
     /    \ _| /
     q .. p \ /
 ...
 \n\n""")
    ...
    if answer == '1':
        ...
        C17()
def C9():
    typewrite(colored(0, 255, 0,"\nThe ghost in the house needs help\n"))
    print ("""
 ...
 """)
    ...
    if answer == '1':
        ...
        C19()
def C10():
    typewrite(colored(0, 255, 0,"\nCat recognises where he is. What does he have?:\n"))
    answer = input(colored(0, 255, 0,"\nDay dream(1) Nightmare/Afternoonmare(2)? :"))
    if answer == '1':
        typewrite("\nDay dream\n")
        C20()
    elif answer == '2':
        typewrite("\nNightmare/Afternoonmare\n")
        C21()
def C11():
    typewrite(colored(0, 255, 0,"\nOuch!!! After a bump on the head. cat remembers where he is...\n"))
    answer = input(colored(0, 255, 0,"\nDay dream(1)     Nightmare(2)? : "))
    if answer == '1':
        typewrite("\nDay dream\n")
        C22()
    elif answer == '2':
        ...
        C23()
def C12():
    typewrite("\nThe Magic cat explains that he can help cat return home. But, it is risky. Never has this spell been used before...\n")
    print ("""
 .✫*ﾟ･ﾟ｡.☆.*｡･ﾟ✫*.
 .✫*ﾟ･ﾟ｡.★.*｡･ﾟ✫*.
 .・。.・゜✭・.・✫・゜・。.
 ...
 X     `-.....-------./ /
  ~-. ~  ~              |
    ...
    ☆ ⌒ ★ ⌒ ☆ ⌒ ★ ⌒ ☆ ⌒ ★ ⌒ ☆☆ ⌒ ★
 \n""")
    answer = input(colored(0, 255, 0,"\nTrust(1)    Don't trust(2)? : "))
    if answer == '1':
        typewrite("\nReceive gift'n'start again\n")
        C24()
    elif answer == '2':
        typewrite("\nParallel universe\n")
        C4()
...
def C14():
    ...
    answer = input(colored(0, 255, 0,"\nmagically spins back home(1)     spins back to the start(2)? :"))
    if answer == '1':
        typewrite("\nMagically spins back home\n")
        game_win()
    elif answer == '2':
        typewrite("\nSpins back to the start\n")
        animals.pop(2)
        animals.insert(2,"")
        animals_ind.pop(2)
        animals_ind.insert(2,"")
        start_game()
def C15():
    typewrite("\nRat saves cat. But, there is a malfuction. Where do they end up?\n\n")
    answer = input(colored(0, 255, 0,"\nCircus(1)    Fair(2)? : "))
    if answer == '1':
        print("\nCircus\n")
        C80()
        ...
        C81()
def C16():
    typewrite("\nYou are not going to help me? ok, I am transporting you back to the:\n\n")
    answer = input(colored(0, 255, 0,"\nStart(1)     Start(2)? : "))
    if answer == '1':
        print("\nStart\n")
        animals.pop(2)
        ...
        start_game()
def C17():
    typewrite("\nThank you for helping. I was testing your kindness, and you have passed. Now here's your reward!\n\n")
    answer = input(colored(0, 255, 0,"\nHome (1)    Start game again(2)? : "))
    if answer == '1':
        typewrite("\nHome\n")
        game_win()
    elif answer == '2':
        ...
        start_game ()
def C18():
    typewrite("\nThanks for nothing. Get out of my house...! \n\n")
    answer = input(colored(0, 255, 0,"\nBack to start(1)    Back to start(2)? : "))
    typewrite("\nBack to start\n")
    animals.pop(2)
    animals.insert(2,"")
    animals_ind.pop(2)
    ...
    start_game ()
def C19():
    typewrite("\nThank you for helping me. I just wanted to find out if you were helpful and kind. I will now reward you with:\n\n")
    answer = input(colored(0, 255, 0,"\nHome(1)     Start(2)? : "))
    if answer == '1':
        typewrite("\nHome\n")
        game_win()
        ...
        start_game()
def C22():
    typewrite("\nYou have been through a traumatic experience. Get away from this situation\n\n")
    answer = input(colored(0, 255, 0,"\nStart again(1)     Ratty start(2)? :\n"))
    if answer == '1':
        print("\nStart\n")
        animals.pop(2)
        animals.insert(2,"")
        ...
        C1()
def C23():
    typewrite("\nCat remembers where he is. The vet surgery is in front of him. It scares me. I want to start again or go just anywhere but here!\n\n")
    answer = input(colored(0, 255, 0,"\nStart again(1)     Ratty start(2)? : "))
    if answer == '1':
        print("\nStart again\n")
        animals.pop(2)
        ...
        C1()
def C24():
    typewrite("\nThe spell has gone wrong. Instead of home, cat is now caught up into a parallel universe\n\n")
    answer = input(colored(0, 255, 0,"\nStart again(1) Enter parallel universe(2)? : "))
    if answer == '1':
        typewrite("\nStart again\n")
        animals.pop(2)
        animals.insert(2,"")
      ...
      ((_(_/    /  /      (_(_(_(---.__    .'
                ...
                | |     \'.
                 \ '....' |
                  '.,___.'
 \n""")
    print(colored(0, 255, 0,"Cat'n'rat fall into a circus. They meet a: \n"))
    answer = input(colored(0, 255, 0,"\nTiger(1)     Monkey(2)? : "))
    if answer == '1':
        typewrite("\nTiger\n")
        C90()
...
def C81():
 ...
 \n""")
    ...
    if answer == '1':
        ...
        C92()
def C20():
    typewrite("\nCat remembers the pet shop and the post office. Which place does he visit?\n\n")
    answer = input(colored(0, 255, 0,"\nPet Shop(1)     Post Office(2)? : "))
    if answer == '1':
        typewrite("\nPet Shop\n")
        C600()
    elif answer == '2':
        ...
        C500()
def C500():
    typewrite("\nIn the Post Office there is a free map and cat snacks. Which one does cat take? Beware wrong choice and you start all over again\n\n")
    answer = input(colored(0, 255, 0,"\nFree Map(1)     Cat Snack(2)? : "))
    if answer == '1':
        typewrite("\nFree Map\n")
        C300()
    elif answer == '2':
        ...
        C400()
def C300():
    typewrite("\nThe map shows cat exactly where home is. Does he:\n\n")
    answer = input(colored(0, 255, 0,"\nReturn home(1)     Start again(2)? : "))
    if answer == '1':
        typewrite("\nReturn home\n")
        game_win()
    elif answer == '2':
        ...
        start_game()
def C400():
    typewrite("\nCat snacks during a crisis? No way:\n\n")
    answer = input(colored(0, 255, 0,"\nReturn home(1)     Start again(2)? : "))
    if answer == '1':
        typewrite("\nStart again\n")
        animals.pop(2)
        ...
        start_game()
def C600():
    typewrite("\nThere is a Parrot in the pet shop, sitting on a perch on the counter. Parrot asks. Can I help you? Be careful not to offend Parrot\n\n")
    print ("""
                           | \/|
   (\   _                  ) )|/|
       (/            _----. /.'.'
...
def C620():
    ...
    if answer == '1':
        ...
        start_game ()
def C21():
    typewrite("\nCat recognises the cat's home in front of him. Where he stayed as a kitten. Cat's sad, and wants to go back too:\n\n")
    answer = input(colored(0, 255, 0,"\nThe Start(1)     Back to Ratty start(2)? : "))
    if answer == '1':
        typewrite("\nStart\n")
        animals.pop(2)
        animals.insert(2,"")
        ...
        C1()
def C90():
    typewrite("\nI'm gonnna tell you a joke, says Tiger. I'm surrounded by pickled vegetables in jars. It's like Piccalili Circus here.\n\n")
    answer = input(colored(0, 255, 0,"\nLaugh(1)     Awful Joke(2)? : "))
    if answer == '1':
        typewrite("\nLaugh\n")
        game_win()
    elif answer == '2':
        ...
        start_game()
def C91():
    typewrite("\nI'm gonnna tell you a joke. What fish do goldfish see when they need an operation? A sturgeon\n\n")
    answer = input(colored(0, 255, 0,"\nLaugh(1)     Awful Joke(2)? : "))
    if answer == '1':
        typewrite("\nLaugh\n")
        game_win()
        ...
        start_game()
def C92():
    typewrite("\nI'm gonnna tell you a joke. Which mouse was a Roman leader and emperor? Julius Cheeser.\n\n")
    answer = input(colored(0, 255, 0,"\nLaugh(1)     Awful Joke(2)? : "))
    if answer == '1':
        typewrite("\nLaugh\n")
        game_win()
        ...
        start_game()
def C100():
    typewrite("\nhey, you now have a choice. \n\n")
    answer = input(colored(0, 255, 0,"\nStart again(1)      Go home(2)? : "))
    if answer == '1':
        typewrite("\nGo home\n")
        game_win()
    elif answer == '2':
